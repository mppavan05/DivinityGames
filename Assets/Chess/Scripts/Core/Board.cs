	...
	public class Board {
		...
		public void MakeMove (Move move, bool inSearch = false) {
			...
			if (capturedPieceType != 0 && !isEnPassant) {
				Debug.Log("Handlecaptures is called");
			...
			// Handle promotion
			if (isPromotion) {
				Debug.Log("is promote is called");
				int promoteType = 0;
				switch (moveFlag) {
				...
				Debug.Log("Other special move is called is called --------->" + moveFlag);
				switch (moveFlag) {
					case Move.Flag.EnPassantCapture:
						Debug.Log("EnPassantCapture is called");
		...
		public void UnmakeMove (Move move, bool inSearch = false) {
			...
			if (isPromotion) {
				Debug.Log("ispromotion is called in unmove " + movedTo);
		...
		public void LoadPosition (string fen) {
			Debug.Log("LoadPosition is called is called");
			Initialize ();
