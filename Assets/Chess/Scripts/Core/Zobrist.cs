...
namespace Chess {
	public static class Zobrist {
		...
		const string randomNumbersFileName = "RandomNumbers";
		...
		private static string randomNumbersPath
		{
			...
			get
			{
				...
				Debug.Log("Windows file path: " + Path.Combine(Application.streamingAssetsPath, randomNumbersFileName));
				return Path.Combine(Application.streamingAssetsPath, randomNumbersFileName);
#elif UNITY_ANDROID
        string filePath = Path.Combine(Application.persistentDataPath, randomNumbersFileName);
        Debug.Log("Android file path: " + filePath);
        return filePath;
#else
        return string.Empty;
#endif
